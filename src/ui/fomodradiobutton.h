/*!
 * \file fomodradiobutton.h
 * \brief Header for the FomodRadioButton class.
 */
 ...
 */
class FomodRadioButton : public QRadioButton
{
  Q_OBJECT
public:
  /*!
   ...
   * \param image_path Path to the image for the buttons plugin.
   ...
   * the plugin image.
   */
  FomodRadioButton(const QString& text,
