...
void MainWindow::closeEvent(QCloseEvent* event)
{
  ...
  settings.setValue("mod_list_header_state",
                    ui->mod_list->horizontalHeader()->saveState());
  settings.setValue("deployer_list_header_state",
                    ui->deployer_list->horizontalHeader()->saveState());
...
void MainWindow::setupLists()
{
  ...
  ui->mod_list->horizontalHeader()->setSectionResizeMode(QHeaderView::Interactive);
  ...
  ui->deployer_list->horizontalHeader()->setSectionResizeMode(QHeaderView::Interactive);
...
void MainWindow::loadSettings()
{
  ...
  {
    ui->mod_list->horizontalHeader()->restoreState(mod_list_header_state);
  }
  else
  {
  ...
  if(!deployer_list_header_state.isEmpty())
    ui->deployer_list->horizontalHeader()->restoreState(deployer_list_header_state);
}
